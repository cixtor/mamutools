...
def usage
    ...
    puts '  -l | --length | Set the length of each password. Default: 10'
    puts '  -c | --count  | Set the quantity of passwords to generate. Default: 1'
    puts '  -t | --type   | Set the character family to use, valid values are "a, A, 1, @" you can combine them: 1a@'
    puts '  -a | --all    | Set the use of all character families, same as: --type "1a@A"'
    exit
end
#
